...
for i, v in pairs(tokens) do
	print(string.format("Type: %s", v.TYPE))
	print(string.format("Data: %s", v.DATA))
	print(string.format("First Pos: %s", v.FIRSTPOS))
	print(string.format("Last Pos: %s", v.LASTPOS))
	print("\n\n")
end
]=======]--